...
- Medication Taken (%)
- Treatment Gap (%) – unmet mental health need

Key Features:
- Trend line chart across time
- KPI Gauge for Treatment Gap
- Top 10 states with the highest gap
- Azure Map
- Slicers for Group, Subgroup, and State
